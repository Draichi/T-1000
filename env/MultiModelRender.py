...
class StockTradingGraph:
    ...
    def __init__(self, df1, df2, df3, render_title):
        ...
        self.price_ax2 = plt.subplot2grid(
            (6, 1), (4, 0), rowspan=2, colspan=1, sharex=self.net_worth_ax)
        self.volume_ax2 = self.price_ax2.twinx()

        self.price_ax3 = plt.subplot2grid(
            (6, 1), (6, 0), rowspan=2, colspan=1, sharex=self.net_worth_ax)
    ...
    def render(self, current_step, net_worth, buy_and_hold, trades, shares_held1, shares_held2, shares_held3, balance, window_size):
